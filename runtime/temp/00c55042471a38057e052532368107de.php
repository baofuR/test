<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\shanchuang\game\public/../application/admin\view\record\kcusertixian.html";i:1557933362;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
                ...
                <td><img src="http://<?php echo $_SERVER['SERVER_NAME'];?><?php echo $vo['tixianma']; ?>" width="54" height="100" class="zoomify"></td>
              ...
              <td><?php echo $vo['yue']; ?></td>
                ...
                <td><a href="JavaScript:tongguo('<?php echo $vo['id']; ?>')" style="color: #3300FF">确认提现</a></td>
            </tr>
