<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\shanchuang\game\public/../application/admin\view\daili\kcxiajinum.html";i:1565760960;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
              ...
              <td><a title="编辑" href="javascript:;"
                       onclick="member_edit('查看下注记录','<?php echo url('admin/daili/viewxiazhu',['id'=>$vo['id']]); ?>','1')"
