<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\shanchuang\game\public/../application/admin\view\daili\erjitixian.html";i:1557310892;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 提现列表 <span
        class="c-gray en">&gt;</span> 提现列表 <a class="btn btn-success radius r"
...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <table class="table table-border table-bordered table-bg">
            <thead>
            <tr>
                <th scope="col" colspan="9">提现列表</th>
            </tr>
            <tr class="text-c">
