<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\shanchuang\game\public/../application/admin\view\record\kcrecordlist.html";i:1557827820;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <table class="table table-border table-bordered table-bg">
            <thead>
            <tr>
                <th scope="col" colspan="9">大吃小大众房记录列表</th>
            </tr>
            <tr class="text-c">
